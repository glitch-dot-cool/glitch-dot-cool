...
import { flicker } from "../../design-system"
    ...
    >
      <Grid>
        <HoverLink coords={coords} sectionID="members">
          <p>
            <GlitchDotCool>glitch[dot]cool</GlitchDotCool> is a collective of
            producers, sound designers, programmers, and visual artists orbiting
            the glitch aesthetic, founded in 2019.
          </p>
        </HoverLink>
        ...
        <HoverLink coords={coords} sectionID="publishing">
          <p>
            we are a collectively operated publishing platform, releasing sample
            packs, albums, and educational content.
          </p>
        </HoverLink>
        ...
        <HoverLink coords={coords} sectionID="discord">
          <p>
            ...
            audiovisual creatives and a focus on education, collaboration, and
            camaraderie.
          </p>
        </HoverLink>
      </Grid>
